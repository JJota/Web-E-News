	...
	<nav class="navbar navbar-inverse navbar-static-top" role="navigation">
		<div class="container">
		    ...
		    <ul class="nav navbar-nav navbar-right">
			    ...
			    <li><a href="AddUsuario.php?adm=<?php echo $_SESSION['admin']; ?>">Cerrar Sesion</a></li>
			</ul>
		</div>
	</nav>
	<!-- FIN Cabecera Menu -->
	...
	<section class="container">
		<div class="row">
			<article class="col-md-6">
				...
				<form role="form" action="" id="formAddUsu" name="formAddUsu" method="post">
            	    	<div class="form-group">
            	    	...
            	    	<input type="submit" class="btn btn-primary" name="btnAddUser" id="btnAddUser" value="Agregar">
